...
`
	...
	f := HookExecutionConfigInit(`{"global":{"discovery":{"kubernetesVersion": "1.25.5", "kubernetesVersions":["1.25.5"], "clusterUUID":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"},},"nodeManager":{"internal": {"static": {"internalNetworkCIDRs":["172.18.200.0/24"]}}}}`, `{}`)
